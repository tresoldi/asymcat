...
def main():
    ...
    parser.add_argument(
        "bump_type", choices=["major", "minor", "patch", "alpha", "beta", "rc"], help="Type of version bump"
    )
    parser.add_argument("--new-version", help="Specific version to set (overrides bump_type)")
    ...
    try:
        ...
        if args.dry_run:
            ...
            print("\nNext steps:")
            print("1. git add pyproject.toml asymcat/__init__.py")
